...
// Nécessaire pour la pagination Suppriméé non fonctionelle
...
class AdminController extends AbstractController
{
	...
	// Gestion des statuts
	public function listeStatut(Request $request,ManagerRegistry $doctrine)
	{
		...
		return $this->render('Admin/statut.html.twig', Array('lesStatuts' => $lesStatuts));
    }

	#[Route('/admin/statut/modif/{id}', name: 'adminStatutModif')]
	// Affichage du formulaire de modification d'un statut
	public function modifStatut($id, Request $request, ManagerRegistry $doctrine)
    {
		// On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
	...
	public function suppStatut($id, Request $request, ManagerRegistry $doctrine) // Affichage du formulaire de suppression d'un statut
    {
		// On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
	...
	// Gestion des clients
	public function listeClient(Request $request, ManagerRegistry $doctrine)
	{
		// On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
		...
		return $this->render('Admin/client.html.twig', Array('lesClients' => $lesClients));
	}
	/**
	...
	public function modifClient($id, Request $request, ManagerRegistry $doctrine) // Affichage du formulaire de modification d'un client
    {
		// On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
     ...
     */
	#[Route('/admin/client/supp/{id}', name:'adminClientSupp')]
	public function suppClient($id, Request $request, ManagerRegistry $doctrine) // Affichage du formulaire de suppression d'un client
    {
        // On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
	...
	public function listeFormation(Request $request, ManagerRegistry $doctrine)
	{
		// On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
		...
		return $this->render('Admin/formation.html.twig', Array('lesFormations' => $lesFormations));
	}
	#[Route('/admin/formation/modif/{id}', name: 'adminFormationModif')]
	// Affichage du formulaire de modification d'une formation
	public function modifFormation($id, Request $request, ManagerRegistry $doctrine) // Affichage du formulaire de modification d'un client
    {
		// On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
	...
	public function suppFormation($id, Request $request, ManagerRegistry $doctrine) // Affichage du formulaire de suppression d'une formation
    {
        // On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
	...
	public function listeSession(Request $request, ManagerRegistry $doctrine)
	{
		// On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
		...
		return $this->render('Admin/session.html.twig', Array('lesSessions' => $lesSessions));
	}
	#[Route('/admin/session/modif/{id}', name: 'adminSessionModif')]
	// Affichage du formulaire de modification d'une session de formation
	public function modifSession($id, Request $request, ManagerRegistry $doctrine) // Affichage du formulaire de modification d'une session de formation
    {
        // On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
	...
	public function suppSession($id, Request $request, ManagerRegistry $doctrine) // Affichage du formulaire de suppression d'une session de formation
    {
        // On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
	...
	public function listePlanFormation(Request $request, ManagerRegistry $doctrine)
	{
		// On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
		...
		return $this->render('Admin/plan.html.twig', Array('lesPlans' => $lesPlans));
	}
	#[Route('/admin/plan/modif/{id}', name: 'adminPlanModif')]
	// Affichage du formulaire de modification d'un plan de formation
	public function modifPlanFormation($id, Request $request, ManagerRegistry $doctrine) // Affichage du formulaire de modification d'un plan de formation
    {
        // On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
     ...
     */
	#[Route('/admin/plan/supp/{id}', name: 'adminPlanSupp')]
	public function suppPlanFormation($id, Request $request, ManagerRegistry $doctrine) // Affichage du formulaire de suppression d'un plan de formation
    {
        // On autorise l'acces uniquement à l'administrateur
		$this->denyAccessUnlessGranted('ROLE_ADMIN');
